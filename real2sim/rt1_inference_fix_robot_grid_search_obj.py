...
if __name__ == '__main__':
    ...
    # main('GraspSingleCokeCanInScene-v0', 'Baked_sc1_staging_table_616385', rgb_overlay_path=rgb_overlay_path)
    # main('GraspSingleCokeCanInScene-v0', 'Baked_sc1_staging_objaverse_cabinet1', rgb_overlay_path=rgb_overlay_path)
    # main('GraspSingleCokeCanInScene-v0', 'Baked_sc1_staging_table83_82cm', rgb_overlay_path=rgb_overlay_path)
    ...
    main('GraspSingleCokeCanInScene-v0', 'Baked_sc1_staging_table_616385',
        ckpt_path='/home/xuanlin/Real2Sim/robotics_transformer/trained_checkpoints/rt1main/')
    main('GraspSingleCokeCanInScene-v0', 'Baked_sc1_staging_objaverse_cabinet1',
        ckpt_path='/home/xuanlin/Real2Sim/robotics_transformer/trained_checkpoints/rt1main/')
    ...
    #      # rgb_overlay_path=rgb_overlay_path, 
    #      tmp_exp=True,
    #      sim_freq=510, control_freq=3, action_repeat=5)
    #      # sim_freq=500, control_freq=4, action_repeat=5)
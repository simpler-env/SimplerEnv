...
def main(env_name, scene_name, ckpt_path='rt_1_x_tf_trained_for_002272480_step',
    ...
    for obj_init_x in obj_init_x_range:
        for obj_init_y in obj_init_y_range:
            ...
            elif env_name in ['GraspSingleCokeCanInScene-v0', 'GraspSingleLightCokeCanInScene-v0', 'GraspSingleOpenedCokeCanInScene-v0', 
                              'GraspSingleUpRightCokeCanInScene-v0', 'GraspSingleUpRightLightCokeCanInScene-v0',
                              'GraspSingleUpRightOpenedCokeCanInScene-v0']:

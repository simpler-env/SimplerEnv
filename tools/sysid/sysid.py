...
if __name__ == '__main__':
    ...
    if args.robot == 'google_robot_static':
        ...
        stiffness_high = np.array([1900, 2100, 1200, 960, 1260, 580, 600])
        stiffness_low = np.array([1700, 1700, 950, 730, 1030, 460, 480])
        damping_high = np.array([1200, 1300, 850, 630, 800, 300, 400])
        damping_low = np.array([830, 930, 600, 360, 500, 200, 240])

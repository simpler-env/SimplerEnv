...
from transforms3d.quaternions import quat2axangle, axangle2quat, mat2quat, quat2mat
        ...
        for j, episode_step in enumerate(episode_steps):
            if dataset_name == 'fractal20220817_data':
                ...
                base_pose_tool_reached = Pose(
                    ...
                    q=mat2quat(euler2mat(*np.array(episode_step['observation']['state'][3:6], dtype=np.float64)) @ mat_transform),
                )
                save_episode_step = {

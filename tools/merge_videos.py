...
python -m pdb tools/merge_videos.py \
    ...
    --output-path results/xid77467904_000400120/google_pick_coke_can_1_v4/arm_pd_ee_delta_pose_align_interpolate_by_planner_gripper_pd_joint_target_delta_pos_interpolate_by_planner/GraspSingleOpenedCokeCanInScene-v0_upright_True_urdf_version_None/merged.mp4
"""

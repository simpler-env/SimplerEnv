...
The original repository code is based in the [SAPIEN](https://sapien.ucsd.edu/) simulator and the CPU based [ManiSkill2](https://maniskill2.github.io/) benchmark. We have also integrated the Bridge dataset environments into ManiSkill3 which offers GPU parallelization and can run 10-15x faster than the ManiSkill2 version, for instructions on how to use the GPU parallelized environments and evaluate on them see: https://github.com/simpler-env/SimplerEnv/tree/maniskill3
